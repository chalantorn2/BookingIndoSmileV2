...
const ConflictResolver = ({
    ...
    return (
      <div key={field} className="border rounded-md p-4 mb-4">
        <h4 className="font-medium text-gray-800 mb-3 flex items-center">
          ...
          Conflict: {fieldLabels[field] || field}
        </h4>
        ...
        <div className="space-y-3">
          ...
          <label className="flex items-start space-x-3 p-3 border rounded-md">
            ...
            />
            <div className="flex-1">
              <div className="font-medium text-blue-700">Custom:</div>
              <input
                type="text"
                value={
                  resolutions[field] !== conflictData.master &&
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold mb-4">Step 3: Resolve Conflicts</h3>

      {!hasConflicts ? (
        <div className="bg-green-50 border border-green-200 p-4 rounded-md mb-4">
          <div className="text-green-700">
            No conflicts found. You can proceed
          </div>
        </div>
      ) : (
        <>
          <p className="text-gray-600 mb-4">
            Conflicts found between Master Record and Duplicate Records.
            Please select the data you want to keep
          </p>
